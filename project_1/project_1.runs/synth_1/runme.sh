...
HD_PWD='C:/study/vlsi/try1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_ckt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_ckt.tcl
