...
HD_PWD='C:/study/vlsi/try1/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_ckt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_ckt.tcl -notrace
