...
HD_PWD='C:/study/vlsi/try1/EITF35/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_TOP_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_TOP_TOP.tcl
