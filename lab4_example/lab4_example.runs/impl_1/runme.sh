...
HD_PWD='C:/study/vlsi/try1/EITF35/lab4/lab4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_TOP_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_TOP_TOP.tcl -notrace
