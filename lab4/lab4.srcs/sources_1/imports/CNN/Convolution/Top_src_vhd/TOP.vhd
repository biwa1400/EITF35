...
entity TOP is
    port (
        ...
        output_dabin          : out std_logic_vector(0 downto 0);
        valid_output_dabin    : out std_logic
	 );
end TOP;
...
architecture TOP_arch of TOP is
    ...
    signal pooling_out_dabin:std_logic_vector(3 downto 0);
    signal valid_pooling_dabin:std_logic;  
    
    signal ofmap_RELU_dabin : std_logic_vector(3 downto 0); 
    signal valid_ofmap_dabin : std_logic;       
    ...
    CONV_TOP_inst : CONV_TOP
        port map(
            ...
            ofmap_dabin => ofmap_RELU_dabin,
            valid_ofmap_dabin => valid_ofmap_dabin
            );
    ...
    Pooling_DABIN_inst : Pooling_DABIN
        port map(
            clk             => clk,
            rst             => rst,
            ofmap_RELU      => ofmap_RELU_dabin,
            valid_data      => valid_ofmap_dabin,
            pooling_out     => pooling_out_dabin,
            valid_pooling   => valid_pooling_dabin
            );
    ...
    FC_DABIN_inst : FC_DABIN
        port map(
            ...
            kernel_FC2_in   => k_FC2_in,
            valid_FC2_in    => valid_k_FC2_in,
            pooling         => pooling_out_dabin,
            valid_pooling   => valid_pooling_dabin,
            output          => output_dabin,       
            valid_output    => valid_output_dabin  );
